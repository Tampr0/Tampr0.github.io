$(document).ready(function() {
  const apiRoot = 'https://suhe-task-manager.herokuapp.com/ /v1/task/';
  const trelloApiRoot = 'https://suhe-task-manager.herokuapp.com/ /v1/trello/';
